...
# -*- coding: utf-8 -*-
"""
Script para generar e insertar datos de prueba con contraseñas correctamente hasheadas
"""
...
password_prof = generate_password_hash('profesor123')
password_est = generate_password_hash('estudiante123')

print("Contraseña profesor hasheada:")
print(password_prof)
print("\nContraseña estudiante hasheada:")
print(password_est)

# Generar SQL con contraseñas correctas
sql = f"""
...
('juan.perez@universidad.edu', '{password_prof}', 'Juan', 'Pérez García', 'profesor', 'Universidad Técnica del Centro', TRUE),
('maria.lopez@universidad.edu', '{password_prof}', 'María', 'López Martínez', 'profesor', 'Universidad Técnica del Centro', TRUE),
('carlos.ruiz@universidad.edu', '{password_prof}', 'Carlos', 'Ruiz Sánchez', 'profesor', 'Universidad Técnica del Centro', TRUE);

-- ======================== INSERTAR USUARIOS ESTUDIANTES ========================
INSERT INTO usuarios (email, password_hash, nombre, apellido, rol, institucion, activo) VALUES
('ana.garcia@estudiante.edu', '{password_est}', 'Ana', 'García Rodríguez', 'alumno', 'Universidad Técnica del Centro', TRUE),
('luis.martinez@estudiante.edu', '{password_est}', 'Luis', 'Martínez Flores', 'alumno', 'Universidad Técnica del Centro', TRUE),
('sofia.diaz@estudiante.edu', '{password_est}', 'Sofía', 'Díaz López', 'alumno', 'Universidad Técnica del Centro', TRUE),
('diego.torres@estudiante.edu', '{password_est}', 'Diego', 'Torres Gómez', 'alumno', 'Universidad Técnica del Centro', TRUE),
('laura.sanchez@estudiante.edu', '{password_est}', 'Laura', 'Sánchez Vargas', 'alumno', 'Universidad Técnica del Centro', TRUE);
...
# Guardar en archivo
with open('datos_prueba_corregidos.sql', 'w', encoding='utf-8') as f:
    f.write(sql)

print("\n✓ Archivo 'datos_prueba_corregidos.sql' creado con contraseñas válidas")
print("\nPara usar:")
print("  mysql -u root -p < datos_prueba_corregidos.sql")
